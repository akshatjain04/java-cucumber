...
roost_feedback [9/17/2024, 7:54:44 PM]:- Add more comments to the test\n- Improve assertions\n- Format the test\n- Improve variable names\n- Comment or remove this test method
*/
...
public class GreeterSayHelloTest {
	...
	public void shouldReturnHelloWorld() {
		...
		assertEquals(expectedGreeting, actualGreeting, "The sayHello() method did not return 'Hello World!'");
	}

	@Test
	@Tag("valid")
	public void shouldReturnNonNullValue() {
		assertNotNull(greeterInstance.sayHello(), "The sayHello() method returned null");
	}

	@Test
	@Tag("valid")
	public void shouldReturnString() {
		assertTrue(greeterInstance.sayHello() instanceof String, "The sayHello() method did not return a string");
	}
